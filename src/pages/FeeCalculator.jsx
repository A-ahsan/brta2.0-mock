...
const FeeCalculator = () => {
  ...
  // Check if embedded (coming from dashboard)
  const isEmbedded = location.state?.embedded || false;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      ...
      <div className={`relative ${isEmbedded ? 'pt-8' : 'pt-24'} pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto`}>
        ...
        {!isEmbedded && (
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-primary to-green-600 rounded-2xl mb-6 shadow-lg shadow-primary/30"
            >
              <Calculator size={40} weight="duotone" className="text-white" />
            </motion.div>
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-4">
              {t.feeCalc?.title || 'Fee Calculator'}
            </h1>
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
              {t.feeCalc?.subtitle || 'Calculate BRTA fees for licenses, registrations, and tax tokens instantly'}
            </p>
          </motion.div>
        )}
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-6">
              <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
                <CurrencyCircleDollar size={24} weight="duotone" className="text-primary dark:text-green-400" />
          ...
          >
            <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-8">
        ...
        {!isEmbedded && (
          <motion.button
            ...
            onClick={() => navigate(-1)}
            className="mt-8 flex items-center gap-2 text-slate-600 dark:text-slate-400 hover:text-primary dark:hover:text-green-400 transition-colors"
          >
            <ArrowLeft size={20} />
            {t.feeCalc?.backButton || 'Back to Dashboard'}
          </motion.button>
        )}
      </div>
    </div>
